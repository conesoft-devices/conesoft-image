...
void setup()
{
    ...
    if((Image = (UBYTE *)malloc(Imagesize/8)) == NULL) {
    ...
    Paint_NewImage(Image, EPD_13IN3B_WIDTH/4, EPD_13IN3B_HEIGHT/4, 0, WHITE);
...
#if 1   // show bmp
    printf("show bmp------------------------\r\n");
    EPD_13IN3B_Display_IMAGE(IMAGE_DATA,250, 100,240,103, 0);
    EPD_13IN3B_Display_IMAGE(IMAGE_DATA,250, 300,240,103, 1);
    DEV_Delay_ms(3000);
#endif
    ...
    //1.Draw black image
    EPD_13IN3B_Init();
    Paint_NewImage(Image, EPD_13IN3B_WIDTH/2, EPD_13IN3B_HEIGHT/4, 0, WHITE);
